...
if [ $ARCH = "amd64" ]; then
  wget https://ftp.morketsmerke.org/immudex/testing/software/librewolf/librewolf-117.0-1.en-US.linux-x86_64.tar.bz2;
  tar -xf librewolf-117.0-1.en-US.linux-x86_64.tar.bz2 -C /usr/lib;
  rm librewolf-117.0-1.en-US.linux-x86_64.tar.bz2;
else
  wget https://ftp.morketsmerke.org/immudex/testing/software/librewolf/librewolf-117.0-1.en-US.linux-i686.tar.bz2;
